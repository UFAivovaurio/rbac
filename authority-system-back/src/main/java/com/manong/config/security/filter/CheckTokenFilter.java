...
public class CheckTokenFilter extends OncePerRequestFilter {
    ...
    */
    private void validateToken(HttpServletRequest request) throws AuthenticationException {
        ...
        //创建身份验证对象
        UsernamePasswordAuthenticationToken authenticationToken = new UsernamePasswordAuthenticationToken(userDetails, null, userDetails.getAuthorities());authenticationToken.setDetails(new WebAuthenticationDetailsSource().buildDetails(request));
